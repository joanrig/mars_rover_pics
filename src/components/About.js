    ...
    <Container>
      <Segment>
        ...
        <div className="about-text">
          ...
          <p>
            <b>Now I'm looking for my first job as a web developer. Yes, that's right, you can hire me. Here's my <a href="https://tinyurl.com/joan-lyness-portfolio">online profile</a> which includes links to demos of my other apps, my LinkedIn profile, resume and contact info. I live near Washington, D.C. Go Nats!</b>
          </p>
        </div>
        <br/>
        <br/>
