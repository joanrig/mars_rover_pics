...
const Intro = () => {
  ...
  return (
    <div className="intro">
      ...
      <p>
        (<em>Note: this site is powered by NASA's Mars Rover Photos API; It does not include photos from Sojourner, but you can <a href="https://www.nasa.gov/mission_pages/mars-pathfinder">find some here.</a></em>)
      </p>
      <p>
